...
def upgrade() -> None:
    ...
    op.add_column(
        "executionhistory",
        sa.Column("mlflow_evaluation_run_id", sa.String(), nullable=True),
    )
    op.create_index(
        "ix_executionhistory_mlflow_evaluation_run_id",
        "executionhistory",
        ["mlflow_evaluation_run_id"],
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_executionhistory_mlflow_evaluation_run_id", table_name="executionhistory"
    )
