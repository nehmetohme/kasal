...
def upgrade():
    ...
    op.add_column(
        "crews",
        sa.Column("process", sa.String(50), nullable=True, server_default="sequential"),
    )

    # Planning configuration
    op.add_column(
        "crews",
        sa.Column("planning", sa.Boolean(), nullable=True, server_default="false"),
    )
    ...
    op.add_column(
        "crews",
        sa.Column("reasoning", sa.Boolean(), nullable=True, server_default="false"),
    )
    ...
    op.add_column(
        "crews", sa.Column("memory", sa.Boolean(), nullable=True, server_default="true")
    )
    op.add_column(
        "crews",
        sa.Column("verbose", sa.Boolean(), nullable=True, server_default="true"),
    )
