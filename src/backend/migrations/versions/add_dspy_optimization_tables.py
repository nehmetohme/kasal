...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_dspy_config_type_active",
        "dspy_configs",
        ["optimization_type", "is_active"],
        unique=False,
    )
    op.create_index(
        "idx_dspy_config_group_type",
        "dspy_configs",
        ["group_id", "optimization_type"],
        unique=False,
    )
    op.create_index(
        "idx_dspy_config_stage", "dspy_configs", ["deployment_stage"], unique=False
    )
    ...
    op.create_index(
        "idx_dspy_example_type_score",
        "dspy_training_examples",
        ["optimization_type", "quality_score"],
        unique=False,
    )
    op.create_index(
        "idx_dspy_example_trace", "dspy_training_examples", ["trace_id"], unique=False
    )
    op.create_index(
        "idx_dspy_example_created",
        "dspy_training_examples",
        ["created_at"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_dspy_run_type_status",
        "dspy_optimization_runs",
        ["optimization_type", "status"],
        unique=False,
    )
    op.create_index(
        "idx_dspy_run_started", "dspy_optimization_runs", ["started_at"], unique=False
    )
    ...
    op.create_index(
        "idx_dspy_cache_key", "dspy_module_cache", ["cache_key"], unique=False
    )
    op.create_index(
        "idx_dspy_cache_type",
        "dspy_module_cache",
        ["optimization_type", "group_id"],
        unique=False,
    )
