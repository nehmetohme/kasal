...
def upgrade() -> None:
    ...
    op.add_column(
        "databricksconfig",
        sa.Column(
            "volume_enabled", sa.Boolean(), nullable=True, server_default="false"
        ),
    )
    op.add_column(
        "databricksconfig", sa.Column("volume_path", sa.String(), nullable=True)
    )
    op.add_column(
        "databricksconfig",
        sa.Column(
            "volume_file_format", sa.String(), nullable=True, server_default="json"
        ),
    )
    op.add_column(
        "databricksconfig",
