...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_conversion_history_execution_id", "conversion_history", ["execution_id"]
    )
    op.create_index("ix_conversion_history_job_id", "conversion_history", ["job_id"])
    op.create_index(
        "ix_conversion_history_source_format", "conversion_history", ["source_format"]
    )
    op.create_index(
        "ix_conversion_history_target_format", "conversion_history", ["target_format"]
    )
    op.create_index(
        "ix_conversion_history_group_id", "conversion_history", ["group_id"]
    )
    op.create_index(
        "ix_conversion_history_group_created",
        "conversion_history",
        ["group_id", "created_at"],
    )
    op.create_index(
        "ix_conversion_history_status_created",
        "conversion_history",
        ["status", "created_at"],
    )
    op.create_index(
        "ix_conversion_history_formats",
        "conversion_history",
    ...
    op.create_index(
        "ix_conversion_jobs_execution_id", "conversion_jobs", ["execution_id"]
    )
    op.create_index("ix_conversion_jobs_group_id", "conversion_jobs", ["group_id"])
    op.create_index(
        "ix_conversion_jobs_group_created",
        "conversion_jobs",
        ["group_id", "created_at"],
    )
    ...
    op.create_index(
        "ix_saved_converter_configurations_group_id",
        "saved_converter_configurations",
        ["group_id"],
    )
    op.create_index(
        "ix_saved_converter_configurations_created_by_email",
        "saved_converter_configurations",
        ["created_by_email"],
    )
    op.create_index(
        "ix_saved_configs_group_user",
        "saved_converter_configurations",
        ["group_id", "created_by_email"],
    )
    op.create_index(
        "ix_saved_configs_formats",
        "saved_converter_configurations",
        ["source_format", "target_format"],
    )
    op.create_index(
        "ix_saved_configs_public",
        "saved_converter_configurations",
