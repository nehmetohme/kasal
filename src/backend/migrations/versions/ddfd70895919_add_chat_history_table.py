...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "email_domain", sa.VARCHAR(length=255), autoincrement=False, nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.VARCHAR(length=100), autoincrement=False, nullable=False),
        sa.Column(
            "tenant_id", sa.VARCHAR(length=100), autoincrement=False, nullable=False
        ),
        sa.Column(
        ...
        sa.ForeignKeyConstraint(
            ["tenant_id"], ["tenants.id"], name="tenant_users_tenant_id_fkey"
        ),
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name="tenant_users_user_id_fkey"
        ),
