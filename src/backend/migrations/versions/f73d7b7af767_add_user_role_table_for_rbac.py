...
def upgrade() -> None:
    ...
    op.drop_index(
        "documentation_embeddings_embedding_idx",
        table_name="documentation_embeddings",
        postgresql_with={"lists": "100"},
        postgresql_using="ivfflat",
    )
    op.drop_index(
        "ix_documentation_embeddings_id", table_name="documentation_embeddings"
    )
    op.drop_index(
        "ix_documentation_embeddings_source", table_name="documentation_embeddings"
    )
    op.drop_index(
        "ix_documentation_embeddings_title", table_name="documentation_embeddings"
    )
    ...
    op.create_unique_constraint(
        "_engine_config_uc", "engineconfig", ["engine_name", "config_key"]
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_execution_logs_tenant_email"),
        "execution_logs",
        ["tenant_email"],
        unique=False,
    )
    op.create_index(
        op.f("ix_execution_logs_tenant_id"),
        "execution_logs",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_executionhistory_tenant_email"),
        "executionhistory",
        ["tenant_email"],
        unique=False,
    )
    op.create_index(
        op.f("ix_executionhistory_tenant_id"),
        "executionhistory",
        ["tenant_id"],
        unique=False,
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_index(
        "ix_tools_created_by_email", "tools", ["created_by_email"], unique=False
    )
    op.create_index(
        "ix_tasks_created_by_email", "tasks", ["created_by_email"], unique=False
    )
    op.alter_column(
        "tasks",
        "markdown",
    ...
    op.create_index(
        "ix_prompttemplate_created_by_email",
        "prompttemplate",
        ["created_by_email"],
        unique=False,
    )
    ...
    op.create_foreign_key(
        "flows_crew_id_fkey", "flows", "crews", ["crew_id"], ["id"], ondelete="CASCADE"
    )
    op.create_index(
        "ix_flows_created_by_email", "flows", ["created_by_email"], unique=False
    )
    op.add_column(
        "flow_executions",
        sa.Column(
            "tenant_email", sa.VARCHAR(length=255), autoincrement=False, nullable=True
        ),
    )
    op.add_column(
        "flow_executions",
    ...
    op.add_column(
        "flow_executions",
        sa.Column(
            "tenant_id", sa.VARCHAR(length=100), autoincrement=False, nullable=True
        ),
    )
    op.create_index(
        "ix_flow_executions_tenant_id", "flow_executions", ["tenant_id"], unique=False
    )
    op.create_index(
        "ix_flow_executions_tenant_email",
        "flow_executions",
        ["tenant_email"],
        unique=False,
    )
    op.create_index(
        "ix_flow_executions_created_by_email",
        "flow_executions",
        ["created_by_email"],
        unique=False,
    )
    ...
    op.drop_index(
        op.f("ix_executionhistory_tenant_email"), table_name="executionhistory"
    )
    op.create_index(
        "ix_executionhistory_created_by_email",
        "executionhistory",
        ["created_by_email"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_execution_trace_created_by_email",
        "execution_trace",
        ["created_by_email"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_crews_created_by_email", "crews", ["created_by_email"], unique=False
    )
    op.alter_column(
        "crews",
        "edges",
    ...
    op.create_index(
        "ix_agents_created_by_email", "agents", ["created_by_email"], unique=False
    )
    op.create_table(
    ...
    op.create_index(
        "ix_documentation_embeddings_title",
        "documentation_embeddings",
        ["title"],
        unique=False,
    )
    op.create_index(
        "ix_documentation_embeddings_source",
        "documentation_embeddings",
        ["source"],
        unique=False,
    )
    op.create_index(
        "ix_documentation_embeddings_id",
        "documentation_embeddings",
        ["id"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_data_processing_che_number", "data_processing", ["che_number"], unique=True
    )
    op.create_table(
        "crew_id_mapping",
