...
from src.engines.kasal.tools.custom.metric_view_utils.utils import run_async as _run_async
...
class UCMetricViewGeneratorTool(BaseTool):
    ...
    def _run(self, **kwargs: Any) -> str:
        ...
        if use_llm and isinstance(mquery_entries, list) and mquery_entries:
            try:
                from src.engines.kasal.tools.custom.metric_view_utils.mquery_parser import (
                ...
                if raw_m_count:
                    from src.engines.kasal.tools.custom.metric_view_utils.mquery_llm_fallback import (
        ...
        validation_results = {}
        try:
            from src.engines.kasal.tools.custom.metric_view_validation_utils.pipeline import (
