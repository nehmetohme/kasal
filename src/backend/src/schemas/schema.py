...
class SchemaBase(BaseModel):
    ...
    schema_type: str = Field(
        ..., description="Type of schema (e.g., 'data_model', 'tool_config')"
    )
    schema_definition: Dict[str, Any] = Field(..., description="JSON schema definition")
    field_descriptions: Optional[Dict[str, str]] = Field(
        default_factory=dict, description="Descriptions for each field in the schema"
    )
    keywords: Optional[List[str]] = Field(
        default_factory=list, description="List of related keywords for search"
    )
    tools: Optional[List[str]] = Field(
        default_factory=list, description="Tools that can use this schema"
    )
    example_data: Optional[Dict[str, Any]] = Field(
        default=None, description="Example data conforming to this schema"
    )
...
class SchemaCreate(SchemaBase):
    ...
    legacy_schema_json: Optional[Dict[str, Any]] = Field(
        default=None, description="Legacy field for schema definition"
    )
...
class SchemaUpdate(BaseModel):
    ...
    name: Optional[str] = Field(
        default=None, description="Unique name identifier for the schema"
    )
    description: Optional[str] = Field(
        default=None, description="Description of what the schema represents"
    )
    schema_type: Optional[str] = Field(
        default=None, description="Type of schema (e.g., 'data_model', 'tool_config')"
    )
    schema_definition: Optional[Dict[str, Any]] = Field(
        default=None, description="JSON schema definition"
    )
    field_descriptions: Optional[Dict[str, str]] = Field(
        default=None, description="Descriptions for each field in the schema"
    )
    keywords: Optional[List[str]] = Field(
        default=None, description="List of related keywords for search"
    )
    tools: Optional[List[str]] = Field(
        default=None, description="Tools that can use this schema"
    )
    example_data: Optional[Dict[str, Any]] = Field(
        default=None, description="Example data conforming to this schema"
    )
