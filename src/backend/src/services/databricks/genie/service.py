...
class GenieService:
    ...
    async def get_spaces(
        self, request: Optional[GenieSpacesRequest] = None
    ) -> GenieSpacesResponse:
        """
    ...
    async def start_conversation(
        ...
        try:
            ...
            request = GenieStartConversationRequest(
                space_id=space_id, initial_message=initial_message, title=title
            )
    ...
    async def send_message(
        self, space_id: str, message: str, conversation_id: Optional[str] = None
        ...
        try:
            ...
            request = GenieSendMessageRequest(
                space_id=space_id, conversation_id=conversation_id, message=message
            )
