...
class LLMLogService:
    ...
    async def count_logs_by_group(
        ...
        return await self.repository.count_logs_by_group(
            endpoint, group_context.group_ids
        )
    ...
    async def get_unique_endpoints_by_group(
        ...
        return await self.repository.get_unique_endpoints_by_group(
    ...
    async def get_log_stats_by_group(
        ...
        endpoint_counts = {}
        for endpoint in endpoints:
            endpoint_counts[endpoint] = await self.count_logs_by_group(
                endpoint, group_context
            )
