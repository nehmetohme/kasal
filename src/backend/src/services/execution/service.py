...
class ExecutionService:
    ...
    def sanitize_for_database(data: Dict[str, Any]) -> Dict[str, Any]:
        """Compatibility facade for execution payload serialization."""
        return sanitize_for_database(data)
    ...
    def _extract_agents_tasks_from_flow_config(self, config: CrewConfig) -> tuple:
        """Derive agent/task naming inputs from a saved or inline flow."""
        return extract_flow_name_inputs(config)
