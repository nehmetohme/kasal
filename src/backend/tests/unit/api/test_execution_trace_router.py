...
class TestExecutionTraceRouter:
    ...
    @patch(
        "src.api.execution_trace_router.ExecutionTraceService.get_all_traces_for_group"
    )
    def test_get_all_traces_success(
        self, mock_get_all_traces, client, mock_group_context
    ):
    ...
    def test_get_all_traces_exception(
        self, mock_get_all_traces, client, mock_group_context
    ):
    ...
    def test_get_traces_by_run_id_success(
        self, mock_get_traces, client, mock_group_context
    ):
    ...
    @patch("src.api.execution_trace_router.ExecutionTraceService.get_traces_by_run_id")
    def test_get_traces_by_run_id_not_found(
        self, mock_get_traces, client, mock_group_context
    ):
    ...
    @patch("src.api.execution_trace_router.ExecutionTraceService.get_traces_by_run_id")
    def test_get_traces_by_run_id_http_exception_reraise(
        self, mock_get_traces, client, mock_group_context
    ):
    ...
    @patch("src.api.execution_trace_router.ExecutionTraceService.get_traces_by_run_id")
    def test_get_traces_by_run_id_exception(
        self, mock_get_traces, client, mock_group_context
    ):
    ...
    def test_get_traces_by_job_id_success(
        self, mock_get_traces, client, mock_group_context
    ):
    ...
    @patch("src.api.execution_trace_router.ExecutionTraceService.get_traces_by_job_id")
    def test_get_traces_by_job_id_not_found(
        self, mock_get_traces, client, mock_group_context
    ):
        ...
        assert response.status_code == 404
        assert (
            "Execution with job_id nonexistent-job not found"
            in response.json()["detail"]
        )

    @patch("src.api.execution_trace_router.ExecutionTraceService.get_traces_by_job_id")
    def test_get_traces_by_job_id_http_exception_reraise(
        self, mock_get_traces, client, mock_group_context
    ):
    ...
    @patch("src.api.execution_trace_router.ExecutionTraceService.get_traces_by_job_id")
    def test_get_traces_by_job_id_exception(
        self, mock_get_traces, client, mock_group_context
    ):
    ...
    @patch(
        "src.api.execution_trace_router.ExecutionTraceService.get_trace_by_id_with_group_check"
    )
    ...
    def test_get_trace_by_id_not_found(
        self, mock_get_trace, client, mock_group_context
    ):
    ...
    def test_get_trace_by_id_http_exception_reraise(
        self, mock_get_trace, client, mock_group_context
    ):
    ...
    def test_get_trace_by_id_exception(
        self, mock_get_trace, client, mock_group_context
    ):
    ...
    @patch(
        "src.api.execution_trace_router.ExecutionTraceService.create_trace_with_group"
    )
    def test_create_trace_success(self, mock_create_trace, client, mock_group_context):
        ...
        mock_create_trace.return_value = {"id": 123, **trace_data}
    ...
    def test_create_trace_exception(
        self, mock_create_trace, client, mock_group_context
    ):
    ...
    @patch(
        "src.api.execution_trace_router.ExecutionTraceService.delete_traces_by_run_id_with_group_check"
    )
    def test_delete_traces_by_run_id_success(
        self, mock_delete_traces, client, mock_group_context
    ):
    ...
    def test_delete_traces_by_run_id_exception(
        self, mock_delete_traces, client, mock_group_context
    ):
    ...
    @patch(
        "src.api.execution_trace_router.ExecutionTraceService.delete_traces_by_job_id_with_group_check"
    )
    def test_delete_traces_by_job_id_success(
        self, mock_delete_traces, client, mock_group_context
    ):
    ...
    def test_delete_traces_by_job_id_exception(
        self, mock_delete_traces, client, mock_group_context
    ):
    ...
    @patch(
        "src.api.execution_trace_router.ExecutionTraceService.delete_trace_with_group_check"
    )
    ...
    def test_delete_trace_not_found(
        self, mock_delete_trace, client, mock_group_context
    ):
    ...
    def test_delete_trace_http_exception_reraise(
        self, mock_delete_trace, client, mock_group_context
    ):
        """Test HTTP exception re-raising in delete_trace."""
        mock_delete_trace.side_effect = HTTPException(
    ...
    def test_delete_trace_exception(
        self, mock_delete_trace, client, mock_group_context
    ):
    ...
    @patch(
        "src.api.execution_trace_router.ExecutionTraceService.delete_all_traces_for_group"
    )
    def test_delete_all_traces_success(
        self, mock_delete_all_traces, client, mock_group_context
    ):
    ...
    def test_delete_all_traces_exception(
        self, mock_delete_all_traces, client, mock_group_context
    ):
    ...
    def test_get_all_traces_with_custom_params(
        self, mock_get_all_traces, client, mock_group_context
    ):
    ...
    def test_get_traces_by_run_id_with_custom_params(self, client, mock_group_context):
        ...
        with patch(
            "src.api.execution_trace_router.ExecutionTraceService.get_traces_by_run_id"
        ) as mock_get_traces:
            mock_get_traces.return_value = {"run_id": 456, "traces": []}

            response = client.get("/traces/execution/456?limit=25&offset=5")

            assert response.status_code == 200
            mock_get_traces.assert_called_once_with(
                group_context=mock_group_context, run_id=456, limit=25, offset=5
            )
    ...
    def test_get_crew_node_states_success(self, client, mock_group_context):
        ...
        mock_result.traces = [
            mock_trace_started,
            mock_trace_completed,
            mock_trace_crew_done,
        ]

        with patch(
            "src.api.execution_trace_router.ExecutionTraceService.get_state_events_by_job_id"
        ) as mock_get_traces:
