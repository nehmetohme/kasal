...
from src.engines.kasal.tools.custom.metric_view_utils.yaml_emitter import _check_metadata_limits
...
from src.engines.kasal.tools.custom.metric_view_utils.yaml_emitter import (
