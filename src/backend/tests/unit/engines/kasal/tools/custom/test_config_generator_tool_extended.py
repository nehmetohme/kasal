...
class TestConfigGeneratorToolExtended:
    ...
    def test_cache_lookup_exception_logs_warning(self):
        ...
        tool = self._tool()
        with patch(
            'src.engines.kasal.tools.custom.config_generator_tool.ConfigGeneratorTool._run',
            wraps=tool._run,
        ):
    ...
    def test_cache_loaded_populates_measures_and_relationships(self):
        ...
        with (
            ...
            patch('src.engines.kasal.tools.custom.metric_view_utils.utils.run_async',
    ...
    def test_measure_resolutions_pipeline_failure_logged(self):
        ...
        tool = self._tool()
        with patch(
            'src.engines.kasal.tools.custom.metric_view_utils.pipeline.MetricViewPipeline',
    ...
    def test_outer_exception_returns_error(self):
        ...
        tool = self._tool()
        with patch(
            'src.engines.kasal.tools.custom.metric_view_utils.mquery_parser.MQueryParser',
