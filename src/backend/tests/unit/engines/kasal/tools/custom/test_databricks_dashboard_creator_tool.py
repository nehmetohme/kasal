...
from src.engines.kasal.tools.custom.databricks_dashboard_creator_tool import (
...
class TestDashboardCreation:
    def test_dashboard_created_via_api(self):
        ...
        with patch.object(tool, "_authenticate", return_value=auth), \
             patch("src.engines.kasal.tools.custom.databricks_dashboard_creator_tool._requests", mock_req, create=True):
