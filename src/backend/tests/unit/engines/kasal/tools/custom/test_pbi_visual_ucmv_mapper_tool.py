...
from src.engines.kasal.tools.custom.pbi_visual_ucmv_mapper_tool import (
...
class TestErrorCases:
    ...
    def test_no_ucmv_output_returns_error(self):
        ...
        tool = PBIVisualUCMVMapperTool()
        with patch(
            "src.engines.kasal.tools.custom.metric_view_validator_tool"
...
class TestLlmSqlSafetyGate:
    ...
    def test_safe_select_helper(self):
        from src.engines.kasal.tools.custom.pbi_visual_ucmv_mapper_tool import _is_safe_select_sql
    ...
    def test_parse_response_nulls_unsafe_sql(self):
        from src.engines.kasal.tools.custom.pbi_visual_ucmv_mapper_tool import PBIVisualUCMVMapperTool
        tool = PBIVisualUCMVMapperTool()
