...
from src.engines.kasal.tools.async_bridge import (
...
class TestToolLLMBridgeRegression:
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                "src.engines.kasal.tools.custom.pbi_visual_ucmv_mapper_tool",
                "PBIVisualUCMVMapperTool",
            ),
            (
                "src.engines.kasal.tools.custom.ucmv_genie_config_generator_tool",
