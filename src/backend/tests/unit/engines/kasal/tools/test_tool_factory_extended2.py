...
class TestImportFallbackCoverage:
    ...
    def test_perplexity_import_fallback_sets_none(self):
        ...
        orig = sys.modules.get("src.engines.kasal.tools.custom.perplexity_tool")

        try:
            # Make it fail
            sys.modules["src.engines.kasal.tools.custom.perplexity_tool"] = None

            # Re-import should use fallback
            if "src.engines.kasal.tools.tool_factory" in sys.modules:
                del sys.modules["src.engines.kasal.tools.tool_factory"]
            ...
            if orig is not None:
                sys.modules["src.engines.kasal.tools.custom.perplexity_tool"] = orig
            elif "src.engines.kasal.tools.custom.perplexity_tool" in sys.modules:
                del sys.modules["src.engines.kasal.tools.custom.perplexity_tool"]
