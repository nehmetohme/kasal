...
from src.services.agent_builder.execution_runner import update_execution_status_with_retry
...
class TestSubprocessTracebackSurfacing:
    ...
    async def test_failed_result_traceback_is_logged(self, caplog):
        ...
        with patch(
            "src.services.agent_builder.execution_runner.process_crew_executor.run_crew_isolated",
