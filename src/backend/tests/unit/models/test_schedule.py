...
class TestSchedule:
    ...
    def test_schedule_with_all_fields(self):
        ...
        agents_config = [
            {"name": "agent1", "role": "analyst", "tools": ["sql", "python"]}
        ]
...
class TestScheduleInputsAndConfiguration:
    ...
    def test_schedule_complex_inputs(self):
        ...
        inputs = {
            ...
            "notifications": {"email": ["admin@company.com"], "slack": "#data-team"},
        }
...
class TestScheduleIndexes:
    ...
    def test_schedule_indexes_exist(self):
        ...
        expected_indexes = ["ix_schedule_group_id", "ix_schedule_created_by_email"]
