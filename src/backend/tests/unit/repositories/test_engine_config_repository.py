...
class TestEngineConfigRepositoryFindAll:
    ...
    async def test_find_all_success(
        self, engine_config_repository, mock_async_session, sample_engine_configs
    ):
    ...
    @pytest.mark.asyncio
    async def test_find_all_empty_result(
        self, engine_config_repository, mock_async_session
    ):
...
class TestEngineConfigRepositoryFindByEngineName:
    ...
    @pytest.mark.asyncio
    async def test_find_by_engine_name_success(
        self, engine_config_repository, mock_async_session
    ):
    ...
    @pytest.mark.asyncio
    async def test_find_by_engine_name_not_found(
        self, engine_config_repository, mock_async_session
    ):
...
class TestEngineConfigRepositoryFindByEngineAndKey:
    ...
    @pytest.mark.asyncio
    async def test_find_by_engine_and_key_success(
        self, engine_config_repository, mock_async_session
    ):
        ...
        result = await engine_config_repository.find_by_engine_and_key(
            "kasal", "flow_enabled"
        )
    ...
    @pytest.mark.asyncio
    async def test_find_by_engine_and_key_not_found(
        self, engine_config_repository, mock_async_session
    ):
...
class TestEngineConfigRepositoryFindEnabledConfigs:
    ...
    @pytest.mark.asyncio
    async def test_find_enabled_configs_success(
        self, engine_config_repository, mock_async_session, sample_engine_configs
    ):
    ...
    @pytest.mark.asyncio
    async def test_find_enabled_configs_none_enabled(
        self, engine_config_repository, mock_async_session
    ):
...
class TestEngineConfigRepositoryFindByEngineType:
    ...
    @pytest.mark.asyncio
    async def test_find_by_engine_type_success(
        self, engine_config_repository, mock_async_session, sample_engine_configs
    ):
        """Test successful search by engine type."""
        workflow_configs = [
            config
            for config in sample_engine_configs
            if config.engine_type == "workflow"
        ]
    ...
    @pytest.mark.asyncio
    async def test_find_by_engine_type_not_found(
        self, engine_config_repository, mock_async_session
    ):
...
class TestEngineConfigRepositoryToggleEnabled:
    ...
    @pytest.mark.asyncio
    async def test_toggle_enabled_success(
        self, engine_config_repository, mock_async_session
    ):
        ...
        with patch.object(
            engine_config_repository, "find_by_engine_name", return_value=config
        ):
    ...
    @pytest.mark.asyncio
    async def test_toggle_enabled_engine_not_found(
        self, engine_config_repository, mock_async_session
    ):
        """Test toggle enabled when engine not found."""
        with patch.object(
            engine_config_repository, "find_by_engine_name", return_value=None
        ):
    ...
    @pytest.mark.asyncio
    async def test_toggle_enabled_disable(
        self, engine_config_repository, mock_async_session
    ):
...
class TestEngineConfigRepositoryUpdateConfigValue:
    ...
    async def test_update_config_value_success(
        ...
        config = MockEngineConfig(
            engine_name="kasal", config_key="flow_enabled", config_value="false"
        )

        with patch.object(
            engine_config_repository, "find_by_engine_and_key", return_value=config
        ):
            result = await engine_config_repository.update_config_value(
                "kasal", "flow_enabled", "true"
            )
    ...
    async def test_update_config_value_not_found(
        ...
        with patch.object(
            engine_config_repository, "find_by_engine_and_key", return_value=None
        ):
            result = await engine_config_repository.update_config_value(
                "kasal", "nonexistent", "value"
            )
    ...
    @pytest.mark.asyncio
    async def test_update_config_value_database_error(
        self, engine_config_repository, mock_async_session
    ):
        ...
        with patch.object(
            ...
            with pytest.raises(Exception, match="Update failed"):
                await engine_config_repository.update_config_value(
                    "kasal", "flow_enabled", "true"
                )
...
class TestEngineConfigRepositoryCrewAIFlowMethods:
    ...
    @pytest.mark.asyncio
    async def test_get_kasal_flow_enabled_true(
        self, engine_config_repository, mock_async_session
    ):
        """Test get CrewAI flow enabled when config exists and is true."""
        config = MockEngineConfig(
            engine_name="kasal", config_key="flow_enabled", config_value="true"
        )
    ...
    @pytest.mark.asyncio
    async def test_get_kasal_flow_enabled_false(
        self, engine_config_repository, mock_async_session
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_kasal_flow_enabled_case_insensitive(
        self, engine_config_repository, mock_async_session
    ):
        ...
        with patch.object(
            engine_config_repository,
            "find_by_engine_and_key",
            return_value=config_mixed,
        ):
            result = await engine_config_repository.get_kasal_flow_enabled()
            assert result is False

    @pytest.mark.asyncio
    async def test_get_kasal_flow_enabled_not_found_defaults_true(
        self, engine_config_repository, mock_async_session
    ):
    ...
    @pytest.mark.asyncio
    async def test_set_kasal_flow_enabled_update_existing(
        self, engine_config_repository, mock_async_session
    ):
        """Test set CrewAI flow enabled by updating existing config."""
        with patch.object(
            engine_config_repository, "update_config_value", return_value=True
        ) as mock_update:
    ...
    @pytest.mark.asyncio
    async def test_set_kasal_flow_enabled_create_new(
        self, engine_config_repository, mock_async_session
    ):
        """Test set CrewAI flow enabled by creating new config when none exists."""
        with patch.object(
            engine_config_repository, "update_config_value", return_value=False
        ):
            with patch.object(
                engine_config_repository, "create", return_value=MockEngineConfig()
            ) as mock_create:
    ...
    @pytest.mark.asyncio
    async def test_set_kasal_flow_enabled_create_error(
        self, engine_config_repository, mock_async_session
    ):
...
class TestEngineConfigRepositoryIntegration:
    ...
    @pytest.mark.asyncio
    async def test_create_then_find_by_engine_and_key(
        self, engine_config_repository, mock_async_session
    ):
        ...
        with patch(
            "src.repositories.engine_config_repository.EngineConfig"
            ...
            with patch.object(
                engine_config_repository, "create", return_value=created_config
            ) as mock_create:
    ...
    @pytest.mark.asyncio
    async def test_toggle_enabled_then_find_enabled_configs(
        self, engine_config_repository, mock_async_session
    ):
        ...
        with patch.object(
            ...
            toggle_result = await engine_config_repository.toggle_enabled(
                "test_engine", True
            )
    ...
    @pytest.mark.asyncio
    async def test_crewai_flow_configuration_workflow(
        self, engine_config_repository, mock_async_session
    ):
...
class TestEngineConfigRepositoryErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_find_by_engine_name_database_error(
        self, engine_config_repository, mock_async_session
    ):
    ...
    @pytest.mark.asyncio
    async def test_find_enabled_configs_database_error(
        self, engine_config_repository, mock_async_session
    ):
    ...
    @pytest.mark.asyncio
    async def test_toggle_enabled_find_error(
        self, engine_config_repository, mock_async_session
    ):
        ...
        with patch.object(
            engine_config_repository,
            "find_by_engine_name",
            side_effect=Exception("Find failed"),
        ):
    ...
    @pytest.mark.asyncio
    async def test_update_config_value_find_error(
        self, engine_config_repository, mock_async_session
    ):
...
class TestEngineConfigRepositoryEdgeCases:
    ...
    @pytest.mark.asyncio
    async def test_config_value_variations(
        self, engine_config_repository, mock_async_session
    ):
    ...
    @pytest.mark.asyncio
    async def test_set_kasal_flow_enabled_boolean_to_string_conversion(
        self, engine_config_repository, mock_async_session
    ):
        """Test that boolean values are correctly converted to strings."""
        with patch.object(
            engine_config_repository, "update_config_value"
        ) as mock_update:
    ...
    @pytest.mark.asyncio
    async def test_find_by_engine_type_multiple_engines(
        self, engine_config_repository, mock_async_session
    ):
    ...
    @pytest.mark.asyncio
    async def test_multiple_configs_same_engine_different_keys(
        self, engine_config_repository, mock_async_session
    ):
    ...
    @pytest.mark.asyncio
    async def test_empty_string_engine_name(
        self, engine_config_repository, mock_async_session
    ):
    ...
    @pytest.mark.asyncio
    async def test_none_config_value_handling(
        self, engine_config_repository, mock_async_session
    ):
...
class TestOtelAppTelemetryMethods:
    ...
    @pytest.mark.asyncio
    async def test_get_otel_enabled_not_found_defaults_false(
        self, engine_config_repository
    ):
        with patch.object(
            engine_config_repository, "find_by_engine_and_key", return_value=None
        ):
    ...
    async def test_set_otel_enabled_update_existing(self, engine_config_repository):
        with patch.object(
            ...
            mock_update.assert_called_once_with(
                "kasal", "otel_app_telemetry_enabled", "true"
            )
    ...
    async def test_set_otel_enabled_create_new(self, engine_config_repository):
        with patch.object(
            ...
            with patch.object(
                ...
                result = await engine_config_repository.set_otel_app_telemetry_enabled(
                    False
                )
                assert result is True
    ...
    @pytest.mark.asyncio
    async def test_set_otel_enabled_create_error(
        self, engine_config_repository, mock_async_session
    ):
        with patch.object(
            engine_config_repository, "update_config_value", return_value=False
            ...
            with patch.object(
                engine_config_repository, "create", side_effect=Exception("DB error")
            ):
    ...
    @pytest.mark.asyncio
    async def test_get_log_level_not_found_defaults_info(
        self, engine_config_repository
    ):
        with patch.object(
            engine_config_repository, "find_by_engine_and_key", return_value=None
    ...
    async def test_set_log_level_update_existing(self, engine_config_repository):
        with patch.object(
            ...
            result = await engine_config_repository.set_otel_app_telemetry_log_level(
                "ERROR"
            )
            assert result is True
            mock_update.assert_called_once_with(
                "kasal", "otel_app_telemetry_log_level", "ERROR"
            )
    ...
    async def test_set_log_level_create_new(self, engine_config_repository):
        with patch.object(
            ...
            with patch.object(
                ...
                result = (
                    await engine_config_repository.set_otel_app_telemetry_log_level(
                        "DEBUG"
                    )
                )
                assert result is True
    ...
    @pytest.mark.asyncio
    async def test_set_log_level_create_error(
        self, engine_config_repository, mock_async_session
    ):
        with patch.object(
            engine_config_repository, "update_config_value", return_value=False
