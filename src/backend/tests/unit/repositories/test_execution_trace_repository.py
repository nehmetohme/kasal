...
class TestCreateTrace:
    ...
    @pytest.mark.asyncio
    async def test_create_trace_raises_error_for_nonexistent_job(
        self, repository, mock_session
    ):
        """Test that error is raised when job doesn't exist."""
        trace_data = {"job_id": "nonexistent-job", "event_type": "task_started"}
    ...
    @pytest.mark.asyncio
    async def test_create_trace_handles_database_error(
        self, repository, mock_session, trace_data
    ):
    ...
    @pytest.mark.asyncio
    async def test_internal_create_without_job_check(
        self, repository, mock_session, trace_data
    ):
...
class TestGetTraceMethods:
    ...
    @pytest.mark.asyncio
    async def test_get_by_run_id_with_pagination(
    ...
    @pytest.mark.asyncio
    async def test_get_by_job_id_with_pagination(
        self, repository, mock_session, mock_traces
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_by_job_id_orders_by_id(
        self, repository, mock_session, mock_traces
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_by_run_id_orders_by_id(
        self, repository, mock_session, mock_traces
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_by_job_id_since_id_filters_new_rows_only(
        self, repository, mock_session, mock_traces
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_by_job_id_without_since_id_reads_from_start(
        self, repository, mock_session, mock_traces
    ):
...
class TestGetCrewCheckpoints:
    ...
    def mock_checkpoint_traces(self):
        ...
        for i, crew_name in enumerate(["ResearchCrew", "AnalysisCrew", "WritingCrew"]):
            ...
            trace.trace_metadata = {"crew_name": crew_name, "agent_role": f"Agent{i}"}
            trace.output = {"output_content": f"Output from {crew_name}"}
            traces.append(trace)
        return traces

    @pytest.mark.asyncio
    async def test_get_crew_checkpoints_extracts_crew_info(
        self, repository, mock_session, mock_checkpoint_traces
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_crew_checkpoints_orders_by_sequence(
        self, repository, mock_session, mock_checkpoint_traces
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_crew_checkpoints_deduplicates_crews(
        self, repository, mock_session
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_crew_checkpoints_handles_missing_crew_name(
        self, repository, mock_session
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_crew_checkpoints_extracts_output_preview(
        self, repository, mock_session, mock_checkpoint_traces
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_crew_checkpoints_includes_timestamp(
        self, repository, mock_session, mock_checkpoint_traces
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_crew_checkpoints_handles_database_error(
        self, repository, mock_session
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_crew_checkpoints_fallback_to_agent_role(
        self, repository, mock_session
    ):
...
class TestGetCrewOutputsForResume:
    ...
    async def test_get_crew_outputs_returns_mapping(self, repository, mock_session):
        ...
        for i, crew_name in enumerate(["ResearchCrew", "AnalysisCrew"]):
            ...
            trace.output = {"output_content": f"Full output from {crew_name}"}
            traces.append(trace)
    ...
    @pytest.mark.asyncio
    async def test_get_crew_outputs_keeps_last_output_per_crew(
        self, repository, mock_session
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_crew_outputs_handles_empty_results(
        self, repository, mock_session
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_crew_outputs_handles_database_error(
        self, repository, mock_session
    ):
        """Test handling of database errors."""
        mock_session.execute = AsyncMock(side_effect=SQLAlchemyError("DB error"))
