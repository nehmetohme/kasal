...
from src.schemas.api_key import ApiKeyBase, ApiKeyCreate, ApiKeyResponse, ApiKeyUpdate
...
class TestApiKeyBase:
    ...
    def test_api_key_base_none_description(self):
        ...
        api_key_data = {"name": "Test Key", "description": None}
        api_key = ApiKeyBase(**api_key_data)
    ...
    def test_api_key_base_empty_description(self):
        ...
        api_key_data = {"name": "Test Key", "description": ""}
        api_key = ApiKeyBase(**api_key_data)
        assert api_key.name == "Test Key"
...
class TestApiKeyCreate:
    ...
    def test_valid_api_key_create_minimal(self):
        ...
        create_data = {"name": "New API Key", "value": "sk-1234567890abcdef"}
    ...
    def test_api_key_create_inheritance(self):
        ...
        create_data = {"name": "Inherited Key", "value": "sk-inherited123"}
        api_key = ApiKeyCreate(**create_data)
    ...
    def test_api_key_create_various_key_formats(self):
        ...
        for key_value in key_formats:
            create_data = {"name": f"Test Key for {key_value[:10]}", "value": key_value}
            api_key = ApiKeyCreate(**create_data)
...
class TestApiKeyUpdate:
    ...
    def test_api_key_update_none_description(self):
        ...
        update_data = {"value": "sk-test123", "description": None}
        update = ApiKeyUpdate(**update_data)
    ...
    def test_api_key_update_empty_description(self):
        ...
        update_data = {"value": "sk-test123", "description": ""}
        update = ApiKeyUpdate(**update_data)
        assert update.value == "sk-test123"
    ...
    def test_api_key_update_description_only_scenarios(self):
        ...
        for desc in test_descriptions:
            update_data = {"value": "sk-constant123", "description": desc}
            update = ApiKeyUpdate(**update_data)
...
class TestApiKeyResponse:
    ...
    def test_api_key_response_id_types(self):
        ...
        # Integer ID
        response_data = {"id": 42, "name": "Integer ID Key", "value": "sk-int123"}
        response = ApiKeyResponse(**response_data)
        assert response.id == 42
        assert isinstance(response.id, int)

        # String that can be converted to int
        response_data = {"id": "123", "name": "String ID Key", "value": "sk-str123"}
        response = ApiKeyResponse(**response_data)
        assert response.id == 123
        assert isinstance(response.id, int)

        # Float that can be converted to int
        response_data = {"id": 99.0, "name": "Float ID Key", "value": "sk-float123"}
        response = ApiKeyResponse(**response_data)
    ...
    def test_api_key_response_invalid_id_types(self):
        ...
        for invalid_id in invalid_ids:
            with pytest.raises(ValidationError):
                ApiKeyResponse(
                    id=invalid_id, name="Invalid ID Key", value="sk-invalid123"
                )
...
class TestSchemaIntegration:
    ...
    def test_api_key_lifecycle_workflow(self):
        ...
        assert (
            response_schema.description == "Updated lifecycle description"
        )  # From update
        assert (
            response_schema.value == "sk-updated-lifecycle1234567890abcdef"
        )  # From update
    ...
    def test_api_key_edge_cases(self):
        ...
        long_create = ApiKeyCreate(
            name=long_name, value=long_value, description=long_description
        )
