...
class TestConnectionRequest:
    ...
    def test_valid_connection_request_minimal(self):
        ...
        request_data = {"agents": [agent], "tasks": [task]}
...
class TestAgentAssignment:
    ...
    def test_valid_agent_assignment(self):
        ...
        assignment_data = {"agent_name": "Data Analyst", "tasks": tasks}
    ...
    def test_agent_assignment_empty_tasks(self):
        ...
        assignment_data = {"agent_name": "Data Analyst", "tasks": []}
        assignment = AgentAssignment(**assignment_data)
        assert assignment.agent_name == "Data Analyst"
...
class TestConnectionResponse:
    ...
    def test_valid_connection_response(self):
        ...
        response_data = {"assignments": assignments, "dependencies": dependencies}
    ...
    def test_connection_response_empty_lists(self):
        ...
        response_data = {"assignments": [], "dependencies": []}
        response = ConnectionResponse(**response_data)
...
class TestApiKeyTestResponse:
    ...
    def test_valid_api_key_test_response(self):
        ...
        python_info = PythonInfo(
            version="3.9.7", executable="/usr/bin/python3", platform="linux"
        )
    ...
    def test_full_connection_workflow(self):
        ...
        assignments = [
            AgentAssignment(
                ...
                tasks=[
                    TaskAssignment(task_name="Data Analysis", reasoning="Perfect match")
                ],
            ),
            AgentAssignment(
                ...
                tasks=[
                    TaskAssignment(
                        task_name="Report Writing", reasoning="Writing expertise"
                    )
                ],
            ),
        ]
        ...
        response = ConnectionResponse(
            assignments=assignments, dependencies=dependencies
        )
