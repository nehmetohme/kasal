...
class TestDocumentationEmbeddingBase:
    ...
    def test_valid_documentation_embedding_base_minimal(self):
        ...
        assert (
            embedding.content
            == "This is a comprehensive guide to getting started with the application."
        )
    ...
    def test_documentation_embedding_base_missing_required_fields(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            DocumentationEmbeddingBase(source="test.md", title="Test Title")
    ...
    def test_documentation_embedding_base_empty_values(self):
        ...
        embedding_data = {"source": "", "title": "", "content": "", "embedding": []}
        embedding = DocumentationEmbeddingBase(**embedding_data)
    ...
    def test_documentation_embedding_base_various_embedding_dimensions(self):
        ...
        embedding_scenarios = [
            ...
            {"name": "medium", "embedding": [0.1] * 100},
            {
                "name": "large",
                "embedding": [0.5] * 1536,
            },  # Common OpenAI embedding size
            {
                "name": "very_large",
                "embedding": [0.0] * 4096,
            },  # Larger model embedding size
        ]
    ...
    def test_documentation_embedding_base_metadata_scenarios(self):
        ...
        metadata_scenarios = [
            {"name": "simple", "metadata": {"category": "tutorial"}},
            {
                "name": "complex",
                "metadata": {
                    "category": "reference",
...
class TestDocumentationEmbedding:
    ...
    def test_documentation_embedding_missing_required_fields(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            DocumentationEmbedding(
                source="test.md", title="Test", content="Content", embedding=[0.1]
            )
...
class TestSchemaIntegration:
        ...
        docs = [
            {
                ...
                "embedding": [
                    ...
                    0.1,
                    0.9,
                ],  # High similarity to "getting started"
                "doc_metadata": {
                    "category": "tutorial",
                    "difficulty": "beginner",
                    "tags": ["intro", "basics"],
            ...
            },
            {
                ...
                "embedding": [
                    ...
                    0.8,
                    0.2,
                ],  # High similarity to "api authentication"
                "doc_metadata": {
                    "category": "reference",
                    "difficulty": "intermediate",
                    "tags": ["api", "auth", "security"],
            ...
            },
            {
                ...
                "embedding": [
                    ...
                    0.9,
                    0.7,
                ],  # High similarity to "troubleshooting"
                "doc_metadata": {
                    "category": "support",
                    "difficulty": "intermediate",
    ...
    def test_documentation_versioning_scenarios(self):
        ...
        original = DocumentationEmbedding(
            ...
            doc_metadata={"version": "1.0", "status": "published"},
        ...
        languages = [
            ...
            },
            {
                ...
                "embedding": [
                    ...
                    0.3,
                    0.8,
                ],  # Similar but different due to language
            },
            {
                "lang": "fr",
                "title": "Commencer",
    ...
    def test_documentation_bulk_operations(self):
        ...
        create_embeddings = [
            DocumentationEmbeddingCreate(**data) for data in bulk_create_data
        ]
