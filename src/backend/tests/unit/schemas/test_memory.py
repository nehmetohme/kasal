...
class TestMemoryListResponse:
    ...
    def test_valid_memory_list_response(self):
        ...
        data = {"memories": ["crew1", "crew2", "crew3"], "count": 3}
...
class TestMemoryActionResponse:
    ...
    def test_valid_memory_action_response_success(self):
        ...
        data = {"status": "success", "message": "Memory reset successfully"}
    ...
    def test_valid_memory_action_response_failure(self):
        ...
        data = {"status": "failure", "message": "Failed to reset memory: access denied"}
        response = MemoryActionResponse(**data)
...
class TestMemorySearchResponse:
    ...
    def test_valid_memory_search_response(self):
        ...
        data = {"results": search_items, "count": 2, "query": "test search"}
    ...
    def test_empty_memory_search_response(self):
        ...
        data = {"results": [], "count": 0, "query": "no matches"}
        response = MemorySearchResponse(**data)
...
class TestMemoryLongTermInfo:
    ...
    def test_valid_memory_long_term_info_minimal(self):
        ...
        data = {"path": "/path/to/memory.db", "size_bytes": 1024000}
...
class TestMemoryComponentInfo:
    ...
    def test_valid_memory_component_info(self):
        ...
        data = {"path": "/path/to/component", "size_bytes": 512000, "file_count": 25}
...
class TestMemoryDetailsResponse:
    ...
    def test_valid_memory_details_response_full(self):
        ...
        long_term = MemoryLongTermInfo(
            path="/path/to/longterm.db", size_bytes=2048000, record_count=100
        )
        short_term = MemoryComponentInfo(
            path="/path/to/shortterm", size_bytes=512000, file_count=10
        )
        entity = MemoryComponentInfo(
            path="/path/to/entity", size_bytes=256000, file_count=5
        )
...
class TestCrewMemoryStats:
    ...
    def test_crew_memory_stats_without_messages(self):
        ...
        data = {"size": 512.25, "last_modified": "2023-01-02T12:00:00Z"}
        stats = CrewMemoryStats(**data)
...
class TestTimeStampedCrewInfo:
    ...
    def test_valid_timestamped_crew_info(self):
        ...
        data = {"crew": "timestamped_crew", "timestamp": "2023-01-01T12:00:00Z"}
...
class TestMemoryStatsResponse:
    ...
    def test_valid_memory_stats_response(self):
        ...
        crew_details = {
            ...
            "crew2": CrewMemoryStats(
                size=200.0, last_modified="2023-01-06T12:00:00Z", messages_count=50
            ),
        }
    ...
    def test_memory_stats_response_without_timestamps(self):
        ...
        data = {
            ...
            "avg_size": 100.0,
            "crew_details": {
                "solo_crew": CrewMemoryStats(
                    size=100.0, last_modified="2023-01-01T12:00:00Z"
                )
            },
        }
        response = MemoryStatsResponse(**data)
...
class TestSchemaIntegration:
    ...
    def test_memory_management_workflow(self):
        ...
        memory_list = MemoryListResponse(
            memories=["analytics_crew", "research_crew"], count=2
        )

        # Search memories
        search_items = [
            MemorySearchItem(
                crew_name="analytics_crew", snippet="data analysis results"
            ),
            MemorySearchItem(crew_name="research_crew", snippet="research findings"),
        ]
        search_response = MemorySearchResponse(
            results=search_items, count=2, query="analysis"
        )

        # Get detailed memory info
        long_term = MemoryLongTermInfo(
            path="/memories/analytics/longterm.db", size_bytes=1024000, record_count=100
        )
        short_term = MemoryComponentInfo(
            path="/memories/analytics/shortterm", size_bytes=256000, file_count=10
        )
        ...
        reset_action = MemoryActionResponse(
            status="success", message="Memory reset completed successfully"
        )

        # Cleanup old memories
        cleanup_response = MemoryCleanupResponse(
            status="success", message="Cleaned up 3 old memory files", count=3
        )
    ...
    def test_memory_statistics_workflow(self):
        ...
        crew1_stats = CrewMemoryStats(
            size=500.0, last_modified="2023-01-01T12:00:00Z", messages_count=75
        )
        crew2_stats = CrewMemoryStats(
            size=750.0, last_modified="2023-01-05T12:00:00Z", messages_count=125
        )
        ...
        stats_response = MemoryStatsResponse(
            ...
            oldest_memory=oldest,
            newest_memory=newest,
            crew_details={"crew1": crew1_stats, "crew2": crew2_stats},
        )
    ...
    def test_memory_search_and_details_workflow(self):
        ...
        search_item = MemorySearchItem(
            crew_name="data_team", snippet="customer behavior analysis shows..."
        )
        search_response = MemorySearchResponse(
            results=[search_item], count=1, query="customer behavior"
        )
        ...
        entity_info = MemoryComponentInfo(
            path="/memories/data_team/entities", size_bytes=128000, file_count=3
        )
