...
class TestCreate:
    ...
    @patch("src.services.chat.dispatcher.TaskGenerationService")
    @patch("src.services.chat.dispatcher.AgentGenerationService")
...
class TestDetectIntent:
    ...
    async def test_mlflow_import_error_handled(self):
        ...
        with (
            ...
            patch("src.services.chat.dispatcher._HAS_MLFLOW", False),
        ):
    ...
    async def test_mlflow_start_span_with_set_inputs_outputs(self):
        ...
        with (
            ...
            patch("src.services.chat.dispatcher._HAS_MLFLOW", True),
            patch("src.services.chat.dispatcher._mlflow", mock_mlflow),
        ):
            result = await svc.detect_intent("find data", "m")
...
class TestMlflowImportFallback:
    ...
    def test_mlflow_import_error_sets_flags(self):
        ...
        # Save original state
        from src.services.chat import dispatcher as ds
...
class TestCircuitBreaker:
    ...
    def test_intent_model_candidates_ordering(self):
        ...
        from src.services.chat.dispatcher import (
