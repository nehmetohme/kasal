...
class TestFormulaTranslator:
    ...
    def test_translate_formula_volume(
        self, translator, kpi_volume_field, simple_definition
    ):
    ...
    def test_translate_formula_amount(
        self, translator, kpi_amount_field, simple_definition
    ):
    ...
    def test_translate_formula_with_source_table(
        self, translator, kpi_with_source_table, simple_definition
    ):
    ...
    def test_translate_formula_count_field(
        self, translator, kpi_count_field, simple_definition
    ):
    ...
    def test_translate_formula_no_prefix(
        self, translator, kpi_no_prefix, simple_definition
    ):
    ...
    def test_translate_formula_returns_all_keys(
        self, translator, kpi_volume_field, simple_definition
    ):
    ...
    def test_full_workflow_simple(
        ...
        # Create measure name
        measure_name = translator.create_measure_name(
            kpi_volume_field, simple_definition
        )
    ...
    def test_full_workflow_with_source_table(
        self, translator, kpi_with_source_table, simple_definition
    ):
        """Test complete workflow with explicit source table"""
        translation = translator.translate_formula(
            kpi_with_source_table, simple_definition
        )
    ...
    def test_edge_case_empty_formula(self, translator, simple_definition):
        ...
        kpi = KPI(description="Empty", technical_name="empty", formula="")
