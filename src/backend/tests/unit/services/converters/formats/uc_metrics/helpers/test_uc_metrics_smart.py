...
from src.services.converters.formats.uc_metrics.helpers.uc_metrics_smart import (
    SmartUCMetricsGenerator,
)
...
class TestSmartUCMetricsGenerator:
    ...
    def metadata(self):
        ...
        return {"name": "test_metrics", "catalog": "main", "schema": "default"}
    ...
    def test_has_dependencies_true_for_calculated(
    ...
    def test_get_recommended_strategy_tree_parsing(
        self, generator, definition_with_dependencies
    ):
    ...
    def test_generate_consolidated_uc_metrics_basic_strategy(
        self, generator, simple_definition, metadata
    ):
    ...
    def test_generate_consolidated_uc_metrics_tree_parsing_strategy(
        self, generator, definition_with_dependencies, metadata
    ):
        """Test generating UC Metrics with tree parsing strategy"""
        result = generator.generate_consolidated_uc_metrics(
            definition_with_dependencies, metadata
        )
    ...
    def test_generate_consolidated_uc_metrics_source_table_qualified(
        self, generator, definition_with_dependencies, metadata
    ):
    ...
    def test_generate_consolidated_uc_metrics_source_table_already_qualified(
    ...
    def test_generate_consolidated_uc_metrics_no_source_table(
        self, generator, metadata
    ):
    ...
    def test_generate_consolidated_uc_metrics_version(
        self, generator, simple_definition, metadata
    ):
    ...
    def test_generate_consolidated_uc_metrics_circular_dependency_error(
        self, generator, metadata
    ):
    ...
    def test_build_consolidated_format_basic(
        self, generator, simple_definition, metadata
    ):
        ...
        result = generator._build_consolidated_format(
            measures, simple_definition, metadata
        )
    ...
    def test_build_consolidated_format_uses_first_source_table(
        self, generator, metadata
    ):
    ...
    def test_build_consolidated_format_custom_catalog_schema(
    ...
    def test_get_analysis_report_dependency_analysis(
        self, generator, definition_with_dependencies
    ):
    ...
    def test_generate_with_no_metadata_name(
        self, generator, definition_with_dependencies
    ):
    ...
    def test_generate_with_no_metadata_catalog(
        self, generator, definition_with_dependencies
    ):
    ...
    def test_generate_with_no_metadata_schema(
        self, generator, definition_with_dependencies
    ):
