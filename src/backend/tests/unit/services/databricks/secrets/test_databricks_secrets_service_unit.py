...
_PATCH_DS = "src.services.databricks.workspace.service.DatabricksService"
_PATCH_AUTH = "src.utils.databricks_auth.get_auth_context"
_PATCH_AKS = "src.services.settings.api_keys.ApiKeysService"
_PATCH_UC = "src.utils.user_context.UserContext"
# aiohttp is imported at module top level, so patch on the service module
_PATCH_AIOHTTP_SESSION = "src.services.databricks.secrets.service.aiohttp.ClientSession"
...
def _make_service(group_id=None):
    ...
    with patch(
        "src.services.databricks.secrets.service.DatabricksConfigRepository"
    ) as MockRepo:
