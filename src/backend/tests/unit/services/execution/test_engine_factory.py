...
async def test_get_engine_kasal_no_initialize():
    ...
    with patch('src.services.execution.engine_service.KasalEngineService', mock_engine_class):
        with patch.dict('sys.modules', {
            'src.services.execution.engine_service': MagicMock(KasalEngineService=mock_engine_class)
        }):
