...
class TestGenerateCrewCode:
    ...
    def test_generate_crew_code_class_based(
        self, generator, sample_agents, sample_tasks
    ):
    ...
    def test_generate_crew_code_for_notebook(
        self, generator, sample_agents, sample_tasks
    ):
    ...
    def test_generate_crew_code_hierarchical_process(
        self, generator, sample_agents, sample_tasks
    ):
    ...
    def test_generate_crew_code_without_comments(
        self, generator, sample_agents, sample_tasks
    ):
    ...
    def test_generate_crew_code_class_name_formatting(
        self, generator, sample_agents, sample_tasks
    ):
...
class TestGenerateTaskMethod:
    ...
    def test_generate_task_method_basic(self, generator):
        ...
        result = generator._generate_task_method(
            task_name="research_task", include_comments=True, for_notebook=False
        )
    ...
    def test_generate_task_method_without_comments(self, generator):
        ...
        result = generator._generate_task_method(
            task_name="research_task", include_comments=False, for_notebook=False
        )
...
class TestGenerateCrewMethod:
    ...
    def test_generate_crew_method_sequential(self, generator):
        ...
        result = generator._generate_crew_method(
            process="Process.sequential", include_comments=True
        )
    ...
    def test_generate_crew_method_hierarchical(self, generator):
        ...
        result = generator._generate_crew_method(
            process="Process.hierarchical", include_comments=True
        )
...
class TestGenerateNotebookCrewCode:
    ...
    def test_generate_notebook_crew_code_with_llm(
        self, generator, sample_agents, sample_tasks
    ):
    ...
    def test_generate_notebook_crew_code_hierarchical(
        self, generator, sample_agents, sample_tasks
    ):
