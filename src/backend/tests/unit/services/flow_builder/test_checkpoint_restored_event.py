...
class TestCrewCheckpointRestoredEvent:
    ...
    def test_the_bridge_maps_and_subscribes_it(self):
        ...
        span_name, event_type = _EVENT_SPAN_MAP["CrewCheckpointRestoredEvent"]
        assert event_type == "crew_checkpoint_restored"
        assert ("src.core.events", "CrewCheckpointRestoredEvent") in _EVENT_CLASSES
        # ...and the exporter must resolve the span back to the same type.
        assert SPAN_NAME_MAP[span_name] == "crew_checkpoint_restored"
