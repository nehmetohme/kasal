...
class TestDataProcessingGuardrail:
    ...
    def test_validate_all_records_processed_success(
    ...
    def test_validate_unprocessed_records_exist(
        self, mock_repo_class, mock_sync_session
    ):
    ...
    def test_validate_no_records_exist(self, mock_repo_class, mock_sync_session):
    ...
    def test_validate_creates_test_data_when_no_records(
        self, mock_repo_class, mock_sync_session
    ):
    ...
    def test_validate_creates_table_on_error(self, mock_repo_class, mock_sync_session):
    ...
    def test_validate_exception_handling(self, mock_sync_session):
    ...
    def test_config_with_json_string_complex(self):
        ...
        config_dict = {
            ...
            "validation_settings": {"strict_mode": False, "allow_partial": True},
        }
