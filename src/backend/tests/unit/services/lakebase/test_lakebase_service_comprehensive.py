...
class TestLakebaseServiceInit:
    ...
    def test_lakebase_service_init_with_session(self):
        ...
        with patch('src.services.lakebase.service.LakebaseConnectionService') as mock_conn_service, \
             patch('src.services.lakebase.service.LakebaseSchemaService') as mock_schema_service, \
             patch('src.services.lakebase.service.LakebasePermissionService') as mock_perm_service:
...
class TestLakebaseServiceConstants:
    ...
    def test_lakebase_available_constant(self):
        ...
        from src.services.lakebase.service import LAKEBASE_AVAILABLE
    ...
    def test_logger_manager_initialization(self):
        ...
        from src.services.lakebase.service import logger_manager
...
from src.services.lakebase.service import (
    _validate_identifier as service_validate_identifier,
)
from src.services.lakebase.migration import (
    _validate_identifier as migration_validate_identifier,
)
from src.services.lakebase.permission import (
...
class TestMigrateExistingDataStreamSequenceReset:
    ...
    @pytest.mark.asyncio
    @patch("src.services.lakebase.service.LAKEBASE_AVAILABLE", True)
    @patch("src.services.lakebase.service.settings")
    @patch("src.services.lakebase.service.create_engine")
    @patch("src.services.lakebase.service.LakebaseMigrationService")
