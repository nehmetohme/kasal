...
class TestCreateInstanceNodeCount:
    ...
    async def test_create_instance_node_count_greater_than_1(self):
        ...
        with patch("src.services.lakebase.service.LAKEBASE_AVAILABLE", True), \
             patch("src.services.lakebase.service.DatabaseInstance") as mock_di, \
...
class TestGetLakebaseSession:
    ...
    async def test_ready_instance_creates_session(self):
        ...
        with patch("src.services.lakebase.service.LAKEBASE_AVAILABLE", True), \
             patch("src.services.lakebase.service.AsyncSession", return_value=mock_session):
...
class TestMigrateExistingDataStream:
    ...
    async def test_schema_only_mode_returns_early(self):
        ...
        with patch("src.services.lakebase.service.LAKEBASE_AVAILABLE", True), \
             ...
             patch("src.services.lakebase.service.create_engine", return_value=MagicMock()), \
