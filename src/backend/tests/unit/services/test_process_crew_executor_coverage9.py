...
def _crew_execution_context(crew, mlflow_result=None, mcp_warnings=None, otel_bridge=None):
    ...
    patches = [
        ...
        patch("src.engines.kasal.callbacks.logging_callbacks.AgentTraceEventListener",
              return_value=mock_agent_listener),
        patch("src.engines.kasal.callbacks.logging_callbacks.TaskCompletionEventListener",
              return_value=mock_task_listener),
        patch("src.engines.kasal.callbacks.execution_callback.create_execution_callbacks",
        ...
        patch("src.engines.kasal.tools.mcp_handler.stop_all_adapters",
              new_callable=AsyncMock),
        ...
        patch("src.engines.kasal.tools.mcp_integration.MCPIntegration.reset_warnings"),
        patch("src.engines.kasal.tools.mcp_integration.MCPIntegration.get_warnings",
              return_value=mcp_warnings or []),
        patch("src.engines.kasal.tools.tool_factory.ToolFactory.create",
