...
class TestTranslateWithLLM:
    ...
    async def test_llm_failure_returns_unchanged(self):
        ...
        with patch("src.services.tools.metric_view_utils.dax_llm_fallback._call_llm",
...
class TestTableContext:
    ...
    def test_context_in_prompt(self):
        from src.services.tools.metric_view_utils.dax_llm_fallback import _build_user_prompt
