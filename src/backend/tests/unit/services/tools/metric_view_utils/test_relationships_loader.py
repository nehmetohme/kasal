...
class TestRelationshipsLoaderBasic:
    def test_basic_many_to_one(self):
        ...
        tables = {
            ...
            "dim": _make_table(
                "dim", "cat.sch.dim", ["key", "label"], agg=[], is_fact=False
            ),
        }
        rels = [
            {
...
class TestRelationshipsLoaderFiltering:
    def test_skip_inactive(self):
        ...
        tables = {
            ...
            "dim": _make_table("dim", "cat.sch.dim", ["k"], agg=[], is_fact=False),
        }
        rels = [
            {
                "from_table": "fact",
    ...
    def test_skip_many_to_many(self):
        ...
        tables = {
            ...
            "dim": _make_table("dim", "d", ["k"], agg=[], is_fact=False),
        }
        rels = [
            {
                "from_table": "fact",
    ...
    def test_skip_system_tables(self):
        ...
        tables = {
            ...
            "LocalDateTable_abc": _make_table(
                "LocalDateTable_abc",
                "cat.sch.dates",
                ["date_key"],
                agg=[],
    ...
    def test_skip_non_fact_table(self):
        ...
        tables = {
            "dim_a": _make_table(
                "dim_a", "cat.sch.dim_a", ["k"], agg=[], is_fact=False
            ),
            "dim_b": _make_table(
                "dim_b", "cat.sch.dim_b", ["k"], agg=[], is_fact=False
            ),
        }
        rels = [
            {
    ...
    def test_skip_same_source_table(self):
        ...
        tables = {
            ...
            "dim": _make_table(
                "dim", "cat.sch.same", ["k", "label"], agg=[], is_fact=False
            ),
        }
        rels = [
            {
...
class TestRelationshipsLoaderRawPbiFormat:
    def test_parse_raw_pbi_format(self):
        ...
        tables = {
            "fact": _make_table("fact", "cat.sch.fact", ["k"]),
            "dim": _make_table(
                "dim", "cat.sch.dim", ["k", "label"], agg=[], is_fact=False
            ),
        }
        raw = {
            "results": [
...
class TestRelationshipsLoaderMultipleJoins:
    def test_multiple_dim_joins(self):
        ...
        rels = [
            {
                "from_table": "fact",
                "from_column": "region_key",
                "from_cardinality": "Many",
                "to_table": "dim_region",
                "to_column": "region_key",
                "to_cardinality": "One",
                "is_active": True,
            },
            {
    ...
    def test_dim_columns_preserved(self):
        ...
        tables = {
            "fact": _make_table("fact", "cat.sch.fact", ["k"]),
            "dim": _make_table(
                "dim", "cat.sch.dim", ["k", "col_a", "col_b"], agg=[], is_fact=False
            ),
        }
        rels = [
            {
