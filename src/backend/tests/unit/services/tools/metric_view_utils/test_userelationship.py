...
class TestInactiveRelationships:
    def test_inactive_rels_collected(self):
        ...
        tables = {
            ...
            "Calendar": _make_table(
                "Calendar", "cat.sch.calendar", ["date"], agg=[], is_fact=False
            ),
        }
        rels = [
            {
    ...
    def test_multiple_inactive_rels(self):
        ...
        tables = {
            ...
            "DimA": _make_table("DimA", "cat.sch.dima", ["key"], agg=[], is_fact=False),
            "DimB": _make_table("DimB", "cat.sch.dimb", ["key"], agg=[], is_fact=False),
        }
        rels = [
            {
                "from_table": "fact",
...
class TestUseRelationshipDAX:
    def test_pattern_matches(self):
        ...
        result = translator.translate(
            {
                "measure_name": "ShipSales",
                "original_name": "Ship Sales",
    ...
    def test_translate_userelationship_simple_sum(self):
        ...
        result = translator.translate(
            {
                "measure_name": "ShipAmount",
                "original_name": "Ship Amount",
                "dax_expression": "CALCULATE(SUM(Sales[Amount]), USERELATIONSHIP(Sales[ShipDate], Calendar[Date]))",
            },
            "Sales",
        )
...
class TestReportEmitterInactiveRelationships:
    def test_inactive_relationships_in_report(self):
        ...
        from src.services.tools.metric_view_utils.report_emitter import (
