...
class TestExtractFromPbiApi:
    ...
    def test_extract_with_access_token_skips_auth(self):
        ...
        with (
            patch('src.services.tools.uc_metric_view_generator_tool.UCMetricViewGeneratorTool._extract_from_pbi_api',
    ...
    def test_extract_no_access_token_calls_auth(self):
        ...
        with (
            patch('src.services.tools.powerbi_auth_utils.get_powerbi_access_token_from_config',
                  mock_get_token),
            patch('src.services.tools.uc_metric_view_generator_tool._run_async',
