...
`src/backend/src/services/tools/`, with shared helpers in
`src/backend/src/services/tools/metric_view_utils/`. Tool numbers match the
...
`src/backend/tests/unit/services/tools/metric_view_utils/`.
